...
print("This is so as we have a letter e in the above string which could not be convert into the int value. That is why we used int? which will help us provide safety n will not lead to crashing.")
...
if let unwrapedAge = userAge {
    print("The age of the current user is \(unwrapedAge)")
} else {
    print("The age of the current user is not available!!")
}
/*:

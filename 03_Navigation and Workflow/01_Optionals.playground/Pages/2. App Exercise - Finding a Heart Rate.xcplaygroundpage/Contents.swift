...
if let unwrapedheartRate = heartRate {
    print("The current Heart Rate is \(unwrapedheartRate)")
    hrAverage = (unwrapedheartRate + oldHR1 + oldHR2 + oldHR3 + oldHR4)/5
    print("The average Heart Rate with current Heart Rate is \(hrAverage)")
} else {
    print("The heart Rate is not available!!")
    hrAverage = (oldHR1 + oldHR2 + oldHR3 + oldHR4)/4
    print("The average heart Rate without current Heart Rate is \(hrAverage)")
}
/*:

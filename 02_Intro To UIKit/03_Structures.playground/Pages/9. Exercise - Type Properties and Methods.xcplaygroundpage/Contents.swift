...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Akshit Goyal", email: "akshit4758@example.com", age: 20)
 ...
 */
var anotherUser = User(userName: "John Doe", email: "johndoe@example.com", age: 30)
User.logIn(user: anotherUser)
var anotherUser2 = User(userName: "John Doe2", email: "johndoe2@example.com", age: 30)
User.logIn(user: anotherUser2)
/*:

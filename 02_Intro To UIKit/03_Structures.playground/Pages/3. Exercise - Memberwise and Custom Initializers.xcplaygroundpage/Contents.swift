...
var  favoriteBook = Book(title: "The Alchemist", author: "Paulo Coelho", pages: 200, price: 600.0)
...
var laptop1 = Laptop(yearPurchased: 2024)
...
struct Height {
    ...
    init (inches: Double) {
        ...
        self.heightInCentimeters = 2.54 * inches
    }
...
var someHeight = Height(inches: 65)
print("Height in Centimeters: \(someHeight.heightInCentimeters)")
print("Height in Inches: \(someHeight.heightInInches)")

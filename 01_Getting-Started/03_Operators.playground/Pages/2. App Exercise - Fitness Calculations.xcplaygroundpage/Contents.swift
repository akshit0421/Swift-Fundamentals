...
print("The new Average Heart Rate is", averageHRD)
print("The difference is that Double allows for more decimal places which is shown in this queston for the above output, it took the the result in interger form")
...
let goal: Double = 100_00
let percentOfGoal: Double = steps / goal * 100
print("The percent of your goal achieved is" ,percentOfGoal)
/*:

...
let intergerDivisionResult: Double = 10 / 3
...
print("This differ from the value when using integer division because the result is in decimal form")
/*:
...
let con1: Int = 2
let con2: Int = 3
let remainder1: Int = con1 % 2
let remainder2: Int = con2 % 2
print(remainder1)
print(remainder2)
print("We could know if an integer is even or odd by looking at the remainder when dividing by 2. If the remainder is 0, the integer is even. If the remainder is 1, the integer is odd.")
/*:

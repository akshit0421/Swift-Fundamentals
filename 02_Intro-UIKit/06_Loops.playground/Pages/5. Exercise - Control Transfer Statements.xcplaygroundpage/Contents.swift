...
var states: [String: String] = ["Arunachal Pradesh": "Itanagar", "Assam": "Dispur", "Punjab": "Chandigarh", "Haryana": "Chandigarh"]
for (name,cap) in states {
    print("\(name)'s capital is \(cap)")
    if (name == "Punjab") {
